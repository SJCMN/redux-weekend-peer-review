...
| Button on Confirmation Page clears Redux and starts a new survey | no | -- button on submit page clears REDUX
...
| --- | :---: |
| More than 15 git commits | yes | 16 commits 
| Commits are descriptive of the changes made or feature added | yes | concise and clear
| Readme file updated | no | - don't forget readme!
| Appropriate amount of code comments | no | comments are for people
| Code is consistently formatted | yes | very clean
...
Mui looks nice! Alert is helpful, nice logic checking input value, good input placeholders.
